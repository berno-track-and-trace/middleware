...
const serialCamera =  new serCam(process.env.SERIALIZATION_CAM_IP,process.env.SERIALIZATION_CAM_PORT, rejector, serCamSensor); //instancing serCam class for serialization Camera
